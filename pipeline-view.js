...
function esDelAnio(d) {
  const a = d.anio_radicacion;
  return a === null || a === undefined || a === "" || String(a) === String(ANIO_CUOTA);
}
          ...
          <table class="tbl" id="pl-tabla">
            <thead>
              <tr>
                ...
                <th data-orden="mes_radicacion">Mes rad. <span class="sort-ico"></span></th>
                <th></th>
              </tr>
            </thead>
